...
Hooshmand email accounts currently use IMAP and SMTP with username/password
...
This is expected. Hooshmand does not support Microsoft OAuth or Graph Mail yet,
